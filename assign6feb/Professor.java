...
public class UniversityManagement {
    ...
    public static void main(String[] args) {
        Professor professor = new Professor("Dr. Smith", "Ece");
        Course course1 = new Course("Computer Science 101", "CS1");
        Course course2 = new Course("Data Structures", "CS2");

        professor.assignCourse(course1);
        professor.assignCourse(course2);

        Student student1 = new Student("Alice", "S1");
        Student student2 = new Student("Bob", "S2");
